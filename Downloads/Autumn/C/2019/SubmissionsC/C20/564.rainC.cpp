      ...
      if(borders[a].leftbig>borders[a].rightbig && borders[a].leftbig>len[a])
        {
         ...
         for(int z=a;z>a-borders[a].diff1;z--){v+=min(borders[a].leftbig,len[a]+b)-len[z];}
         fl=1;
         }
...
*/
      if(borders[a].rightbig>borders[a].leftbig && borders[a].rightbig>len[a])
        {
         ...
         for(int z=a;z<a+borders[a].diff2;z++)v+=min(borders[a].rightbig,len[a]+b)-len[z];
         fl=1;
         }
    /*  else if(borders[a].rightbig>borders[a].leftbig && borders[a].rightbig>len[a])
        ...
        */
        if(fl)len[a]+=max(min(b,borders[a].leftbig-len[a]),min(b,borders[a].rightbig-len[a]));
